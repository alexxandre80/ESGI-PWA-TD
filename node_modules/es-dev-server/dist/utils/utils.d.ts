 ...
 */
export declare function isIndexHTMLResponse(ctx: Context, appIndex?: string): Promise<boolean>;
export declare function isPolyfill(url: string): boolean;
export declare function shoudlTransformToModule(url: string): boolean;
